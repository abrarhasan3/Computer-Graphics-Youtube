...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        translationMatrix = glm::translate(identityMatrix, glm::vec3(0.6, 0.1 , 0.0f));
        rotationMatrix = glm::rotate(identityMatrix, glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
